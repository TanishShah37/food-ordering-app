    ...
    <>
      <div className='MainPage_container'>
        <div className='MainPage_nav_container'>
          <div className='navTitle'> AttainU Food Ordering App </div>{' '}
          <div className='MainPage_nav_Inner'>
            ...
            <div className='navBtns'>
              {user ? (
                ...
                <button onClick={loginPopUp} className='navBtn'>
                  {' '}
                  Log In{' '}
                </button>
              )}{' '}
              {!user ? (
                <button onClick={signupPopUp} id='sup' className='navBtn'>
                  {' '}
                  Sign Up{' '}
                </button>
              ) : null}{' '}
              <button onClick={showCart} className='navBtn'>
                {' '}
                Cart{' '}
              </button>{' '}
            </div>
        ...
        <div className='mainPage_main_container'>
          ...
          {cityName ? (
            <div className='mainPage_main_data_container'>
              <div className='mainPage_main_data_Title'>
                {' '}
                Restaurants in {camelize(cityName)}{' '}
              </div>{' '}
              <div className='filterCollapse'>
                {' '}
                <button onClick={showFilter} className='filterCollapseBtn'>
                  {' '}
                  ☰Filters{' '}
                </button>
              </div>
                ...
                <div className='MainPage_filter_container'>
                  ...
                  {dataFetch ? (
                    <div>
                      ...
                      <div className='filterTitle'> Location </div> {listItems}{' '}
                    </div>
                  ) : null}{' '}
                </div>
                      ...
                      return (
                        ...
                        >
                          <div className='mainPage_restaurent_card_container'>
                            ...
                            <div className='res_cuisines'>
                              {' '}
                              {items.restaurant.cuisines}{' '}
                            </div>{' '}
                            <div className='marginBot'> </div>{' '}
                            <div className='rate-cost'>
                              ...
                              4 ? (
                                <div className='res_rating_green'>
                                  {' '}
                                  {
                                    items.restaurant.user_rating
                                      .aggregate_rating
                                  }{' '}
                                </div>
                              ) : (
                                <div className='res_rating_red'>
                                  {' '}
                                  {
                                    items.restaurant.user_rating
                                      .aggregate_rating
                            ...
                            <div className='res_timing'>
                              {' '}
                              {items.restaurant.timings}{' '}
                            </div>{' '}
                            <div className='marginBot'> </div>{' '}
                            <div className='res_loc'>
                              {' '}
                              {items.restaurant.location.address}{' '}
                            </div>
                          </div>{' '}
                        </div>
                      )
