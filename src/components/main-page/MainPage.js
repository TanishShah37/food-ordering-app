          ...
          <div className='MainPage_nav_Inner'>
            <div className='navSearches'>
              <div>
                ...
                />
                <button id="searchNewCity" onClick={onSearchHandler}>Search</button>
              </div>
                        ...
                        <div className="mainPage_restaurent_inner_container"
                          ...
                          <div className="mainPage_restaurent_card_container">
                            <div className="res_img_area">
                              <img src={items.restaurant.thumb ? items.restaurant.thumb
 : "https://b.zmtcdn.com/data/res_imagery/17806994_RESTAURANT_4fb2520c85f9936ec0524b4efda6e62a_c.jpg?fit=around%7C200%3A200&crop=200%3A200%3B%2A%2C%2A"} alt="Restaurant Img" />
                            </div>
      ...
      {loginPopup ? (
        <SignUpOrLogIn popUp={loginPopUp} hidePopup={hidePopup} flagOne={loginPopup} />
      ) : null}
      {signupPopup ? (
        <SignUpOrLogIn popUp={signupPopUp} hidePopup={hidePopup} flagTwo={signupPopup} />
      ) : null}
    </>
  );
}
